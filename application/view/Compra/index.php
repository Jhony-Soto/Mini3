...
<div class="col-lg-12">
    <div class="card bg-secondary collapse-card">     
        <div class="card-header">
            <h3 class="card-title"><i class="nav-icon far fa-plus-square"></i> Realizar una Compra</h3>
        ...
        <div class="card-body text-center">
			<div class="bg-dark rounded px-4 pt-2 pb-1 mb-3">
				<form class="d-flex mb-5" id="compraForm">
					<div class="col-lg-8" >
						<label class="ml-3">PROVEEDOR</label>
						<select class="form-control selectProvedor " id="proveedor"  required>
							<option value="" selected disabled>Seleccione</option>
						</select>
					</div>
					<div class="col-lg-4  mt-4" >
						<button class="btn btn-outline-primary mb-3" type="submit" id="comprar">Generar Compra</button>
					</div>
				</form>
			</div>
...
<div class="col-lg-12">
    <div class="card bg-secondary collapse-card">     
        <div class="card-header">
            <h3 class="card-title"><i class="nav-icon far fa-plus-square"></i> Historial de compras relizadas hoy</h3>
